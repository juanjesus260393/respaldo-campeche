 ...
 *   Fecha: 10-10-2018
 *   Versión: 1.0
 *   Descripcion: Controlador de la funcion que Permite validar o rechazar un Sitio
...
//Se verifica si ya se aprobo o rechazo el sitio
if(isset($_GET['opc'])){
    switch($_GET['opc']){
//Si se acepto        
        case 'A':
...
$accept=$sit->acepta_sitio($sitio, $idrevision, $comentario);
...
$noaccept=$sit->rechaza_sitio($sitio,$comentario, $idrevision);
