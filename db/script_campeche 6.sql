...
CREATE TABLE `ad` (
  ...
  PRIMARY KEY (`id_ad`),
  KEY `fk_ad_revision_objeto1_idx` (`id_revision_objeto`),
  CONSTRAINT `fk_ad_revision_objeto1` FOREIGN KEY (`id_revision_objeto`) REFERENCES `revision_objeto` (`id_revision_objeto`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cupon` (
  ...
  `limite_codigos` int(11) NOT NULL,
...
CREATE TABLE `empresa` (
  ...
  `id_rango_ventas` int(11) NOT NULL,
  ...
  KEY `fk_empresa_rango_ventas1_idx` (`id_rango_ventas`),
  CONSTRAINT `fk_empresa_plan1` FOREIGN KEY (`id_plan`) REFERENCES `plan` (`id_plan`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_empresa_rango_ventas1` FOREIGN KEY (`id_rango_ventas`) REFERENCES `rango_ventas` (`id_rango_ventas`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `imagen_galeria` (
  ...
  KEY `fk_imagen_galeria_revision_informacion1_idx` (`id_revision_informacion`),
  CONSTRAINT `fk_imagen_galeria_revision_informacion1` FOREIGN KEY (`id_revision_informacion`) REFERENCES `revision_informacion` (`id_revision_informacion`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-07-12 16:30:10
