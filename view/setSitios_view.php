                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-2">
                                                ...
                                                <div class="choose_file">
                                                    ...
                                                    <input type="file" id="idperfilSet" name="idperfilSet" accept=".jpg"   name="idlogoSet" 
                                            ...
                                            <div class="col-2">
                                                ...
                                                <div class="choose_file">
                                                    ...
                                                    <input type="file" id="idlogoSet" name="idlogoSet" accept=".jpg"   name="idlogoSet" 
                                                                           style="-webkit-appearance:none;     
                                                           position:absolute;
                                                           top:0;
                                                           left:0;
                                            ...
                                            <div class="col-2">
                                                ...
                                                <div class="choose_file">
                                                    ...
                                                    <input type="file" id="idcartaSet" name="idcartaSet" accept=".pdf"   name="idlogoSet" 
                                                                           style="-webkit-appearance:none;     
                                                           position:absolute;
                                                           top:33%;
...
// If necessary, you could initiate an AJAX request here (and then do the updating in a callback).
                                                ...
                                                $('#idlogoSet').on("change", function(){ 
                                                    var file = document.getElementById('idlogoSet').value.split('\\');
                                                        document.getElementById('idlogo').src = "../Imagenes/Sitios/logo/" + file[file.length-1];                                           
    
                                                    });
                                                    $('#idperfilSet').on("change", function(){ 
                                                    var file2 = document.getElementById('idperfilSet').value.split('\\');
                                                        document.getElementById('idperfil').src = "../Imagenes/Sitios/img/" + file2[file2.length-1];                                           
                                                    ...
                                                    var file3 = document.getElementById('idcartaSet').value.split('\\');
                                                       document.getElementById('srcpdf').src = "../Imagenes/Sitios/carta/" + file3[file3.length-1];
