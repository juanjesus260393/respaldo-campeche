...
<!-- The Modal Flyer-->
        ...
        <!-- Modal Header -->
           <div class="modal-header">
                    ...
                    <div class="modal-body text-center">
                        ...
                        <img src="Imagenes/flyer.jpg" class="img-fluid" width="152" height="118">
                    </div>
        <!-- Modal footer -->
 ...
 <!-- Modal Banner -->
 <div class="modal" id="modalBanner" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        ...
                        <img src="Imagenes/banner.png" class="img-fluid" width="304" height="236">
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                    </div>
