    ...
    <div id="consulta">
        ...
        <table class="table" style='border: 1px solid grey; -moz-border-radius: 15px;' align='center'>
            ...
            <thead class="thead-dark" align='center'>
                <tr>
                    <th scope="col">Titulo del Cupon</th>
                    <th scope="col">Cantidad de cupones</th>
                    <th scope="col">Porcentaje Cupones Canjeados</th>
                    <th scope="col">Total de Cupones Canjeados</th>
                </tr>
            </thead>
            <tbody>
                <?php
...
inner join cupon c on c.id_cupon = q.id_cupon inner join revision_objeto r on c.id_revision_objeto = r.id_revision_objeto where (c.vigencia_inicio <= '$fa' and c.vigencia_fin >= '$fa') and r.id_empresa = " . $_SESSION['idemp'] . " and q.canjeado = 1 group by c.id_cupon;";
                ...
                for ($j = 0; $j <= $c - 1; $j++) {
                    $a++;
                    echo "<tr class='btn-outline-primary'><td>" . $titulo[$j];
