...
?>"></span>
        ...
        <div>
            ...
            <span><input type="text" id="descripcion" name="descripcion" value="<?php echo $descripcion; ?>"></span>
        </div>   
        <div>
...
?>"></span>
        ...
        <div>
            ...
            <span><input type="file" id="id_img_preview" accept=".jpg" name="id_img_preview"></span>
