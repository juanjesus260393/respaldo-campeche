...
?>"></span>
            ...
            <div>
                ...
                <span><input type="text" id="nombre" name="nombre" placeholder="Titulo del Puesto/Vacante" maxlength="48" required></span>
            </div> 
            <div>
            ...
            <div>
                ...
                <span> <input type="text" required id="horario" placeholder="ejem: de 7:00 am a 5:00 pm" name="horario" maxlength="48"></span>
            </div>

             <div>
                <span><label>Escolaridad:</label></span>
                <span> <input type="text" required id="escolaridad" placeholder="Licenciatura" name="escolaridad" maxlength="48"></span>
            </div>

             <div>
                <span><label>Habilidades:</label></span>
                <span> <textarea required id="habilidades" placeholder="ejem: Puntual,Responsable,Proactivo" name="habilidades" maxlength="48"></textarea></span>
            </div>

             <div>
                <span><label>Descripción:</label></span>
                <span> <textarea required id="descripcion" placeholder="Se solicita la vacante para el area de oficinas" name="descripcion" maxlength="495"></textarea></span>
            </div>
            ...
            <div>
                ...
                <span><input type="number" placeholder="Años" id="experiencia" name="experiencia" required maxlength="990"></span>
            </div>
