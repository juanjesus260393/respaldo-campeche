    ...
    <center><table border="1">
            ...
            for ($i = 0; $i < count($llenar); $i++) {
                ...
                <tr>
                    ...
                    <td> <?php echo "<a href='../view/actualizarCupon.php?id_empresa=$idemp&id_revision_objeto=$idrob&id_cupon=$idcup&titulo=$t&descripcion_corta=$dc&descripcion_larga=$dl&terminos_y_condiciones=$tyc&limite_codigos=$limcd'><img src='img/actualizar.jpg'/></a>" ?></td>
                </tr>
                <?php
            }
            ?>
